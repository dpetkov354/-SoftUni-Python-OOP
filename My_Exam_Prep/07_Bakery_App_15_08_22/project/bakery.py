...
class Bakery:
    ...
    def add_food(self, food_type: str, name: str, price: float):
        Validator.bakery_food_or_drink_duplicate(food_type, name, self.food_menu)
    ...
    def add_drink(self, drink_type: str, name: str, portion: float, brand: str):
        Validator.bakery_food_or_drink_duplicate(drink_type, name, self.drinks_menu)
    ...
    def add_table(self, table_type: str, table_number: int, capacity: int):
        Validator.bakery_table_duplicate(table_number, self.tables_repository)
